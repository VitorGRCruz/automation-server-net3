...
- Ajuste operacional concluído com seleção dinâmica do stack Docker do Temporal por `NODE_ENV` ou `TEMPORAL_DOCKER_MODE`, alternando entre `start-dev` e overlay self-hosted com PostgreSQL, UI e admin-tools.
